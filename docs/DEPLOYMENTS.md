...
## 2026-09-18 — [Staging] AI-generate action for entry and directory SEO metadata

**Branch/PR:** `feat/2026-09-18-directory-seo-ai-generate` (not yet opened).
