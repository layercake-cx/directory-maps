...
## 2026-08-20 — [Staging] Two more entitlements: seats and data_rows
...
- `20260820160000_seed_seats_and_data_rows_entitlements.sql` applied to **staging** (`beqejxneehilplrtpntn`) via `supabase db push`. Embedded post-migration `DO` block raised `VERIFY PASSED`. **Not applied to production.**
