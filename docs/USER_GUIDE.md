...
Under **Auto-sync schedule**, choose **Off** (manual only) or **Daily**, then pick the hour (UTC) when the sync should run each day. See [GOOGLE_SHEETS_SYNC.md](./GOOGLE_SHEETS_SYNC.md).
