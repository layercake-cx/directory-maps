...
| `seo_og_image_url` | `text null` | Directory-level default social share image (og:image/twitter:image) for the landing page, and a fallback for entries without their own `directory_entries.og_image_url`. Added 20260914210000; editable via the same Settings tab panel. |
